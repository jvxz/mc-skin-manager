...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 fixed inset-0 z-50 bg-black/80 backdrop-blur-sm duration-100 ease-out data-[state=closed]:animate-out data-[state=open]:animate-in',
        className,
      )}
      {...props}
    />
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        <div
          className={cn(
            'mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded bg-accent group-data-[vaul-drawer-direction=bottom]/drawer-content:block',
          )}
        />
        {children}
      </DrawerPrimitive.Content>
